...
class MatchItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Padding(
        padding: const EdgeInsets.only(left: 36, top:10,bottom: 10,right:30),
        child: Row
        (
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: const [
            Text("الأحد 20 نوفمبر" , style: TextStyle(
              color: kWhiteColor,
              fontSize: 18,
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    const Text("قطر" , style: TextStyle(
                      color: kWhiteColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold
                ...
                Column(
                  // ignore: prefer_const_literals_to_create_immutables
                  children: [
                    const Text("الإكوادور" , style: TextStyle(
                      color: kWhiteColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold
