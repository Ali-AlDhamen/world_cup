...
class ResultsOptionsBar extends StatefulWidget {
  const ResultsOptionsBar({super.key});

  @override
  State<ResultsOptionsBar> createState() => _ResultsOptionsBarState();
}

class _ResultsOptionsBarState extends State<ResultsOptionsBar> {
  bool btn1 = false;
  bool btn2 = true;
  bool btn3 = false;
  @override
